...
2. Pick the Rutronix RDK Kit "RutDevKit-PSoC62" from the list shown in the **Project Creator - Choose Board Support Package (BSP)** dialog.
...
The following example will clone the "[Hello World](https://github.com/ddka22/rutronix-mtb-example-rdk2-hello-world)" application with the desired name "MyHelloWorld" configured for the *RutDevKit-PSoC62* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id RutDevKit-PSoC62 --app-id mtb-example-psoc6-hello-world --user-app-name MyHelloWorld --target-dir "C:/mtb_projects"
   ```
